    ...
    var Template_JS = {
        ...
        pre_loader: function () {
            ...
            $.LoadingOverlay(class_show, {
                ...
                fade  : true,          // Animate the overlay div. Options (true, false)
        ...
        header_slider: function (options) {
            ...
            // Changeable Options
            options = {
                animateCanvas                 : true,  // Whether Sequence.js should automatically control the canvas animation when a step is navigated to.
